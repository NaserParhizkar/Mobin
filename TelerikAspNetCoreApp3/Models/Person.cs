...
namespace Northwind.WebUI.Models
{
    ...
    public class PersonValidator : AbstractValidator<Person>
    {
        public PersonValidator()
        {
            ...
            RuleFor(x => x.Age).GreaterThanOrEqualTo(18)
                ...
                .WithMessage("You must be between 18 and 110 to submit this form");

            RuleFor(x => x.Location).NotNull()
                .WithMessage("Please tell us your location, we promise not to tell anyone");
        }
    }
    ...
    public class FluentValidator<TValidator> : ComponentBase where TValidator : IValidator, new()
    {
        ...
        {
            var validationResult = validator.Validate(new ValidationContext<object>(editContext.Model));
            messages.Clear();
