...
*/
(function(f, define){
    define(["./kendo.core", "./kendo.binder", "./kendo.window", "./kendo.list", "./kendo.tabstrip", "./kendo.color",
        "./kendo.sortable", "./kendo.menu", "./kendo.data", "./kendo.dom", "./kendo.toolbar", "./kendo.colorpicker",
        "./kendo.combobox", "./kendo.dropdownlist", "./kendo.popup", "./kendo.treeview"], f);
})(function(){
