        ...
        (function ($, undefined) {
            ...
            var ObservableObject = Observable.extend({
                ...
                set: function (field, value) {
                    ...
                    //        value = value instanceof pDate ? value.persianFormat() : value;
                    //    }
                    //}
            ...
            var parsers = {
                ...
                "string": function (value) {
                    //naser edited
                    return value != null ? (value instanceof pDate ? value.persianFormat() : value + "") : value;
                },
            ...
            var DataSource = Observable.extend({
                init: function (options) {
                    ...
                    that.notification = new kendo.ui.Notification(errorElement);
                    //naser/////////////////////////////////////////////////////////////////////
                },
                notification: {},
                options: {
                            ...
                            if (that.online()) {
                                that.transport.read({
                                    ...
                                    success: function (data) {
                                        ...
                                        for (var errorLst in data.Errors) {
                                            for (var error in data.Errors[errorLst]) {
                                                that.notification.show({
                                                    title: "وضیعت عملیات",
                                                    message: data.Errors[errorLst][error][0]
                                                }, "error");
                                            }
                                        }
                                        //naser///////////////////////////////////////////////////////////////////////////////////////
                ...
                error: function (xhr, status, errorThrown) {
                    this.showExceptionModal(xhr, status, errorThrown);
                    this._dequeueRequest();
                    this.trigger(REQUESTEND, {});
                    this.trigger(ERROR, { xhr: xhr, status: status, errorThrown: errorThrown });
                },

                showExceptionModal: function (xhr, status, errorThrown) {
                    var jsonResponseText = JSON.parse(xhr.responseText);
                    var divError = $('<div><div style="white-space: normal;" id="exceptionJstree"></div></div>').appendTo('body');
                    $("#exceptionJstree").kendoTreeView({
                        dataSource: jsonResponseText.items,
                        select: function (e) {
                            e.preventDefault();
                        },
                        "animation": { "expand": { "effects": "expand:vertical" } } 
                    });

                    divError.kendoWindow({
                        actions: ['Maximize', 'Close'],
                        title: "خطا",
                        modal:true,
                        close: function () {
                            if ($('#exceptionJstree').length > 0)
                                $('#exceptionJstree').remove();
                        },
                        width:800,
                        content: $('#errorTree').html()
